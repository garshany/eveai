...
- `OPENAI_MODEL=gpt-5.6-luna` is the default: fast and cheap for latency-sensitive, high-volume deployments. Use `gpt-5.6-terra` for a capability/cost balance or `gpt-5.6-sol` for quality-first work. The `gpt-5.6` alias routes to Sol.
