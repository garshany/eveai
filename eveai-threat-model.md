...
chats and Discord DMs are its product surfaces. Fastify exposes only the EVE
SSO login redirect and callback plus `GET /health`; there is no web dashboard,
browser session, Telegram Login Widget, or Telegram-to-browser handoff.
