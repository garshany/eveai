...
vi.mock('../../src/config.js', () => ({
  config: {
    ...
    openai: {
      ...
      maxClientSearchCallsPerResponse: 8,
      maxEveKillCallsPerTurn: 60,
      maxEveKillAnalyticsCallsPerTurn: 12,
      ...
      maxTotalTurnReadLeaves: 96,
      readSubagentMaxTasks: 8,
      readSubagentMaxWorkers: 6,
      readSubagentMaxWorkerIterations: 8,
      readSubagentMaxModelCalls: 24,
      readSubagentAggregateChars: 60_000,
      readSubagentBatchDeadlineMs: 600_000,
      responsesTimeoutMs: 300_000,
