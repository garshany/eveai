...
- The gate applies only to updates **sent before this process started**: long polling is sequential, so a live message can legitimately wait behind a long agent turn for longer than the window and must never be skipped.
