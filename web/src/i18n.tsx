...
const RU = {
  ...
  placeholder: 'Спросите о Новом Эдеме…', message: 'Сообщение', send: 'Отправить сообщение', attachments: 'Вложения пока недоступны', thinking: 'Модель формирует ответ',
...
const EN: Record<keyof typeof RU, string> = {
  ...
  placeholder: 'Ask about New Eden…', message: 'Message', send: 'Send message', attachments: 'Attachments are not available yet', thinking: 'The model is preparing an answer',
