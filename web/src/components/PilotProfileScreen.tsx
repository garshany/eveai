...
type Props = { character: Character | null; csrfToken: string; onMenu: () => void; onConnect: () => void };
 ...
 */
export function PilotProfileScreen({ character, csrfToken, onMenu, onConnect }: Props) {
