...
7. tool_search → ESI — live данные: ордера, скиллы, ассеты, кошелёк, местоположение, контракты, почта, флот, структуры, текущие sovereignty, incursions.
8. tool_search → EVE-KILL (eve_kill namespace) — killmails, PvP контекст, entity stats, battle reports, build prices.
9. web_search — последний вариант: мета/патч-ноуты/community, не-EVE, или когда пользователь просит.
