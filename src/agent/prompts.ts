...
<route_skill>
plan_route prefer: "secure" по умолчанию, "shortest" для быстрых перелётов, "insecure" для лоусек/нулей, "thera_shortcut" когда пользователь просит маршрут через вормхол/ВХ/Thera/Turnur или просит поставить автопилот по шорткату. thera_shortcut ставит 3 waypoint'а: вход WH → выход WH → цель.
