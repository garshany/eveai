...
export const config = {
  ...
  zkill: {
    ...
    userAgent: optional('ZKILL_USER_AGENT', 'EVEAI/2.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
  ...
  eveKill: {
    ...
    userAgent: optional('EVE_KILL_USER_AGENT', 'EVEAI/2.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
  ...
  eveScout: {
    ...
    userAgent: optional('EVE_SCOUT_USER_AGENT', 'EVEAI/2.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
