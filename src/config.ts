...
export const config = {
  ...
  esi: {
    ...
    userAgent: optional('ESI_USER_AGENT', 'EVEAI/3.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
  ...
  eveKill: {
    ...
    userAgent: optional('EVE_KILL_USER_AGENT', 'EVEAI/3.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
  ...
  eveScout: {
    ...
    userAgent: optional('EVE_SCOUT_USER_AGENT', 'EVEAI/3.1 (+https://github.com/example/eveai; contact=operator@example.com)'),
